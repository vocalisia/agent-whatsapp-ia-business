...
const sectorIntents: Record<string, BotResponse> = {
  ...
  spa: {
    text: "**Spa & Wellness — HotelLux**\n\n**Espace detente** (inclus pour les residents)\n- Piscine interieure chauffee (28°C)\n- Sauna finlandais + hammam\n- Salle de fitness 24/7\n\n**Soins sur reservation :**\n\n**Massage relaxant** — 60 min — estimation personnalisee\n**Massage sportif** — 60 min — estimation personnalisee\n**Soin visage premium** — 75 min — estimation personnalisee\n**Ritual oriental** — 90 min — estimation personnalisee\n**Package couple** — 120 min — estimation personnalisee\n\n**Horaires :** 7h00 - 21h00\n\nReservation recommandee 24h a l'avance.\n\nQuel soin vous interesse ?",
    delay: 2200,
    quickReplies: [
  ...
  excursions: {
    text: "**Excursions & Activites locales**\n\n**Demi-journee :**\n- Visite guidee vieille ville — estimation personnalisee\n- Degustation vins locaux — estimation personnalisee\n- Randonnee panoramique — estimation personnalisee\n\n**Journee complete :**\n- Croisiere cotiere + dejeuner — estimation personnalisee\n- Safari 4x4 arriere-pays — estimation personnalisee\n- Cours de cuisine locale — estimation personnalisee\n\n**Experiences premium :**\n- Helicoptere survol cote — estimation personnalisee\n- Plongee sous-marine — estimation personnalisee\n- Yacht prive demi-journee — estimation personnalisee (4 pers max)\n\nReservation via WhatsApp, depart depuis l'hotel.\n\nQuelle activite vous tente ?",
    delay: 2200,
    quickReplies: [
