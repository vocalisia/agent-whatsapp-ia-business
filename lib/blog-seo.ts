...
const SOURCE_LIBRARY: SourceDefinition[] = [
  ...
  {
    key: "service-public-recouvrement-amiable",
    title: {
      fr: "Entreprendre Service-Public - Recouvrement amiable",
      en: "Entreprendre Service-Public - Amicable debt collection",
      de: "Entreprendre Service-Public - Aussergerichtliches Inkasso",
      nl: "Entreprendre Service-Public - Minnelijke invordering",
    },
    url: "https://entreprendre.service-public.fr/vosdroits/F38586",
    label: {
      fr: "Cadre officiel sur les relances, la mise en demeure et les suites possibles.",
      en: "Official guidance on reminders, formal notice and possible next steps.",
      de: "Offizielle Hinweise zu Mahnungen, Inverzugsetzung und moeglichen Folgeschritten.",
      nl: "Officiele uitleg over herinneringen, ingebrekestelling en vervolgstappen.",
    },
    kind: "institutional",
    tags: /recouvrement|créance|creance|facture impayée|facture impayee|mise en demeure|relance|amiable|judiciaire/i,
  },
  {
    key: "service-public-injonction-payer",
    title: {
      fr: "Entreprendre Service-Public - Injonction de payer",
      en: "Entreprendre Service-Public - Payment order",
      de: "Entreprendre Service-Public - Zahlungsbefehl",
      nl: "Entreprendre Service-Public - Betalingsbevel",
    },
    url: "https://entreprendre.service-public.fr/vosdroits/F38156",
    label: {
      fr: "Référence publique sur l'injonction de payer en France et en Europe.",
      en: "Public reference on payment-order procedures in France and Europe.",
      de: "Oeffentliche Referenz zum Zahlungsbefehlsverfahren in Frankreich und Europa.",
      nl: "Publieke referentie over betalingsbevelprocedures in Frankrijk en Europa.",
    },
    kind: "institutional",
    tags: /injonction|assignation|payer|commissaire de justice|huissier|titre exécutoire|titre executoire/i,
  },
  {
    key: "legifrance-code-civil-2224",
    title: {
      fr: "Légifrance - Article 2224 du Code civil",
      en: "Legifrance - Civil Code Article 2224",
      de: "Legifrance - Code civil Artikel 2224",
      nl: "Legifrance - Burgerlijk Wetboek artikel 2224",
    },
    url: "https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000019017112",
    label: {
      fr: "Texte officiel du délai de droit commun pour les actions personnelles ou mobilières.",
      en: "Official text for the ordinary limitation period for personal or movable actions.",
      de: "Offizieller Text zur allgemeinen Verjaehrungsfrist fuer persoenliche oder bewegliche Ansprueche.",
      nl: "Officiele tekst over de gewone verjaringstermijn voor persoonlijke of roerende vorderingen.",
    },
    kind: "institutional",
    tags: /prescription|délai|delai|cinq ans|5 ans|ancienneté|anciennete/i,
  },
  {
    key: "legifrance-code-commerce-l441-10",
    title: {
      fr: "Légifrance - Article L441-10 du Code de commerce",
      en: "Legifrance - Commercial Code Article L441-10",
      de: "Legifrance - Code de commerce Artikel L441-10",
      nl: "Legifrance - Handelswetboek artikel L441-10",
    },
    url: "https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000038414392",
    label: {
      fr: "Texte officiel sur pénalités de retard et indemnité forfaitaire entre professionnels.",
      en: "Official text on late-payment penalties and flat recovery compensation between professionals.",
      de: "Offizieller Text zu Verzugsfolgen und pauschaler Inkassoentschaedigung zwischen Unternehmen.",
      nl: "Officiele tekst over laattijdige betaling en forfaitaire invorderingsvergoeding tussen professionals.",
    },
    kind: "institutional",
    tags: /intérêts|interets|retard|b2b|indemnité|indemnite|forfaitaire|pénalité|penalite|paiement entre professionnels/i,
  },
  {
    key: "dgccrf-recouvrement-amiable",
    title: {
      fr: "DGCCRF - Recouvrement amiable de créances",
      en: "DGCCRF - Amicable debt collection rules",
      de: "DGCCRF - Regeln fuer aussergerichtliches Inkasso",
      nl: "DGCCRF - Regels voor minnelijke invordering",
    },
    url: "https://www.economie.gouv.fr/dgccrf/les-fiches-pratiques/recouvrement-amiable-de-creances-les-regles-connaitre",
    label: {
      fr: "Rappel institutionnel sur les pratiques de recouvrement amiable à connaître.",
      en: "Institutional reminder of the rules that apply to amicable collection practices.",
      de: "Institutionelle Hinweise zu Regeln fuer aussergerichtliche Inkassopraktiken.",
      nl: "Institutionele uitleg over regels voor minnelijke invorderingspraktijken.",
    },
    kind: "institutional",
    tags: /société de recouvrement|societe de recouvrement|agence recouvrement|avis|pratiques|débiteur|debiteur|pression/i,
  },
  {
    key: "service-public-saisie-bancaire",
    title: {
      fr: "Service-Public - Saisie sur compte bancaire",
      en: "Service-Public - Bank-account seizure",
      de: "Service-Public - Kontopfaendung",
      nl: "Service-Public - Beslag op bankrekening",
    },
    url: "https://www.service-public.fr/particuliers/vosdroits/F1850",
    label: {
      fr: "Fiche officielle sur la saisie bancaire et les conditions d'exécution.",
      en: "Official guidance on bank-account seizure and enforcement conditions.",
      de: "Offizielle Hinweise zu Kontopfaendung und Vollstreckungsbedingungen.",
      nl: "Officiele uitleg over bankbeslag en uitvoeringsvoorwaarden.",
    },
    kind: "institutional",
    tags: /saisie|attribution|bancaire|banque|compte bancaire|exécution forcée|execution forcee/i,
  },
  {
    key: "ecb-key-rates",
    title: {
      fr: "Banque centrale européenne - Taux directeurs",
      en: "European Central Bank - Key interest rates",
      de: "Europaeische Zentralbank - Leitzinsen",
      nl: "Europese Centrale Bank - Beleidsrentes",
    },
    url: "https://www.ecb.europa.eu/stats/policy_and_exchange_rates/key_ecb_interest_rates/html/index.en.html",
    label: {
      fr: "Source officielle du taux de refinancement utilisé comme repère de calcul.",
      en: "Official source for the refinancing rate used as a calculation reference.",
      de: "Offizielle Quelle fuer den Referenz-Refinanzierungssatz.",
      nl: "Officiele bron voor de herfinancieringsrente als berekeningsreferentie.",
    },
    kind: "institutional",
    tags: /bce|ecb|taux|intérêts|interets|retard|refinancement/i,
  },
  {
    key: "eurlex-late-payment",
    title: {
      fr: "Commission européenne - Observatoire des paiements",
      en: "European Commission - Payment Observatory",
      de: "Europaeische Kommission - Zahlungsobservatorium",
      nl: "Europese Commissie - Betalingsobservatorium",
    },
    url: "https://single-market-economy.ec.europa.eu/smes/challenges-and-resilience/late-payment/eu-payment-observatory_en",
    label: {
      fr: "Cadre européen applicable aux retards de paiement dans les transactions commerciales.",
      en: "European framework for late payment in commercial transactions.",
      de: "EU-Rahmen fuer Zahlungsverzug im Geschaeftsverkehr.",
      nl: "Europees kader voor betalingsachterstand in handelstransacties.",
    },
    kind: "institutional",
    tags: /europe|européen|europeen|directive|retards de paiement|transactions commerciales|b2b/i,
  },
  {
    key: "pwc-working-capital",
    title: {
      fr: "PwC - Working Capital Study",
      en: "PwC - Working Capital Study",
      de: "PwC - Working Capital Study",
      nl: "PwC - Working Capital Study",
    },
    url: "https://www.pwc.co.uk/services/value-creation/insights/working-capital-study/2024.html",
    label: {
      fr: "Analyse de cabinet sur créances clients, trésorerie et besoin en fonds de roulement.",
      en: "Consulting analysis of receivables, liquidity and working capital.",
      de: "Beratungsanalyse zu Forderungen, Liquiditaet und Working Capital.",
      nl: "Consultancystudie over vorderingen, liquiditeit en werkkapitaal.",
    },
    kind: "consulting",
    tags: /trésorerie|tresorerie|dso|tableau de bord|working capital|créances clients|creances clients|pme/i,
  },
  {
    key: "cnil-ai-rgpd",
    title: {
...
const PRIORITY_LINKS: Record<BlogLocale, Array<{ slug: string; label: string }>> = {
  fr: [
    { slug: "recouvrement-creance-whatsapp-pme", label: "Recouvrement créance PME" },
    { slug: "facture-impayee-pme-relance-whatsapp", label: "Facture impayée PME" },
    { slug: "lettre-mise-en-demeure-facture-impayee", label: "Lettre mise en demeure facture impayée" },
    { slug: "injonction-de-payer-en-ligne-facture", label: "Injonction de payer en ligne" },
    { slug: "logiciel-relance-impaye-pme", label: "Logiciel relance impayé PME" },
    { slug: "agent-ia-whatsapp-recouvrement-creance", label: "Agent IA WhatsApp recouvrement" },
