...
import juridqueConfig from "@/components/demo/configs/juridique";
...
const pageMeta: Record<string, { title: string; description: string }> = {
  fr: {
    title: "Agent IA WhatsApp Juridique | Demo interactive JurisAssist",
    description:
      "Testez notre agent IA WhatsApp pour cabinets d'avocats. Prise de RDV, analyse documents, suivi dossier, estimation honoraires, urgences juridiques.",
  },
  en: {
    title: "Legal WhatsApp AI Agent | Interactive Demo",
    description:
      "Try our WhatsApp AI agent for law firms. Appointment booking, document analysis, case tracking, fee estimation, legal emergencies.",
  },
  de: {
    title: "Juristische WhatsApp KI-Agent | Interaktive Demo",
    description:
      "Testen Sie unseren WhatsApp KI-Agenten fur Anwaltskanzleien. Terminbuchung, Dokumentenanalyse, Fallverfolgung, Honorarschatzung.",
  },
  nl: {
    title: "Juridische WhatsApp AI-agent | Interactieve demo",
    description:
      "Test onze WhatsApp AI-agent voor advocatenkantoren. Afspraken, documentanalyse, dossierbeheer, honorariumschatting.",
  },
};
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates(locale, "/demo/juridique"),
  };
}
...
const capabilities = [
  {
    ...
    desc: "Planification automatique de consultations juridiques avec confirmation et rappels WhatsApp",
  },
  {
    icon: Briefcase,
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-20">
          ...
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            >
              Agent IA pour{" "}
              <span className="text-gradient-wa">cabinets d&apos;avocats</span>
            </h1>
            <p className="text-lg text-slate-400 max-w-xl mx-auto">
              Automatisez la prise de RDV, le suivi dossier et la qualification
              client. Votre assistant juridique IA disponible 24h/24 sur WhatsApp.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex justify-center lg:justify-end order-1 lg:order-1">
              <WhatsAppSimulator config={juridqueConfig} />
            </div>
