...
const pageMeta: Record<string, { title: string; description: string }> = {
  ...
  en: {
    ...
    description:
      "Try our automotive WhatsApp AI agent. Vehicle search, test drive booking, trade-in estimate, AI financing and scheduled maintenance.",
  },
  de: {
    title: "Automobil Demo | WhatsApp KI-Agent fur Autohauser",
    description:
      "Testen Sie unseren Automobil WhatsApp KI-Agenten. Fahrzeugsuche, Probefahrt, Inzahlungnahme, KI-Finanzierung und Wartungsplanung.",
  },
  nl: {
    title: "Automobiel Demo | WhatsApp AI-agent voor autodealers",
    description:
      "Test onze automobiel WhatsApp AI-agent. Voertuig zoeken, proefrit, inruil, AI-financiering en gepland onderhoud.",
  },
};
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates(locale, "/demo/automobile"),
  };
}
...
export default function AutomobileDemoPage() {
  return (
    <>
      {/* Hero section */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex justify-center lg:justify-end order-1 lg:order-1">
              <WhatsAppSimulator config={automobileConfig} />
            </div>
            ...
            <div className="order-2 lg:order-2 flex flex-col gap-8">
              ...
              <div className="bg-gradient-to-br from-wa/10 to-indigo-500/10 border border-wa/20 rounded-2xl p-6 text-center">
                ...
                >
                  <Zap size={18} />
                  Audit automobile gratuit — 30 min
                </a>
              </div>
            </div>
          </div>
