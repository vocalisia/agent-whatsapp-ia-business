...
| Modell | DE-Genauigkeit | Mehrsprachige Genauigkeit | Latenz | Kosten/Min |
|--------|----------------|--------------------------|--------|------------|
| **Whisper v3 large** | 95% | 99 Sprachen, ausgezeichnet | 2-4 s | $0.006 |
| **GPT-4o Audio** | 97% | 50 Sprachen, top tier | 1-2 s | $0.015 |
| **Deepgram Nova-2** | 93% | 30 Sprachen | &lt;1 s | $0.004 |
| **AssemblyAI Universal** | 92% | 28 Sprachen | 1.5 s | $0.005 |
| **Google Speech-to-Text** | 93% | 125 Sprachen | 1-2 s | $0.016 |
...
"Guten Tag, ich suche ein Angebot für eine Einbauküche, Eiche, ca. 18m², Induktionskochfeld, Pyrolyse-Backofen, Maximalbudget 15.000 Euro". Der Agent identifiziert alle Kriterien, prüft den Katalog, generiert ein vorausgefülltes Angebot.
...
## Was kostet ein WhatsApp-Agent mit Sprachtranskription?

Ab **290 €/Monat** (AgenticWhatsup KMU-Standardpaket), alles inklusive:

- WhatsApp Business Cloud API
- Whisper v3 oder GPT-4o Audio Transkription
- Orchestrierender LLM (Claude Sonnet oder GPT-4)
...
Für 5000+ Sprachnachrichten/Monat oder spezielle Bedürfnisse (dediziertes Modell, Fachvokabular), individuelles Angebot. [Kostenloses 30-Min-Audit →](/de/contact)
