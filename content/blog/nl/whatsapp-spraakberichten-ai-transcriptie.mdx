...
| Model | NL-nauwkeurigheid | Meertalige nauwkeurigheid | Latentie | Kost/min |
|-------|-------------------|--------------------------|----------|----------|
| **Whisper v3 large** | 95% | 99 talen, uitstekend | 2-4 s | $0.006 |
| **GPT-4o Audio** | 97% | 50 talen, top tier | 1-2 s | $0.015 |
| **Deepgram Nova-2** | 93% | 30 talen | &lt;1 s | $0.004 |
| **AssemblyAI Universal** | 92% | 28 talen | 1.5 s | $0.005 |
| **Google Speech-to-Text** | 93% | 125 talen | 1-2 s | $0.016 |
...
"Hallo, ik zoek een offerte voor een uitgeruste keuken, eiken, ongeveer 18m², inductiekookplaat, pyrolyse-oven, maximaal budget 15000 euro". De agent identificeert alle criteria, controleert de catalogus, genereert een vooraf ingevulde offerte.
...
## Wat kost een WhatsApp-agent met spraaktranscriptie?

Vanaf **€290/maand** (AgenticWhatsup KMO standaardpakket), alles inbegrepen:

- WhatsApp Business Cloud API
- Whisper v3 of GPT-4o Audio-transcriptie
- Orchestrerend LLM (Claude Sonnet of GPT-4)
...
Voor 5000+ spraakberichten/maand of specifieke behoeften (toegewijd model, vakvocabulaire), maatwerkofferte. [Gratis 30-min audit →](/nl/contact)
