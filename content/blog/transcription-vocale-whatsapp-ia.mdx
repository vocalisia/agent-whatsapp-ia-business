...
| Modèle | Précision FR | Précision multi-langue | Latence | Coût/min |
|--------|--------------|-----------------------|---------|----------|
| **Whisper v3 large** | 96% | 99 langues, excellent | 2-4 s | 0,006 $ |
| **GPT-4o Audio** | 97% | 50 langues, top tier | 1-2 s | 0,015 $ |
| **Deepgram Nova-2** | 94% | 30 langues | &lt;1 s | 0,004 $ |
| **AssemblyAI Universal** | 93% | 28 langues | 1,5 s | 0,005 $ |
| **Google Speech-to-Text** | 92% | 125 langues | 1-2 s | 0,016 $ |
...
"Bonjour, je cherche un devis pour une cuisine équipée chêne, environ 18m², plaque induction, four pyrolyse, prix max 15000 euros". L'agent identifie tous les critères, vérifie le catalogue, génère un devis pré-rempli.
...
## Combien coûte un agent WhatsApp avec transcription vocale ?

À partir de **290 €/mois** (forfait PME standard AgenticWhatsup), tout inclus :

- WhatsApp Business Cloud API
- Transcription Whisper v3 ou GPT-4o Audio
- LLM orchestrateur (Claude Sonnet ou GPT-4)
- Intégration CRM/agenda (HubSpot, Pipedrive, Cal.com, Make.com)
- Hébergement EU + conformité RGPD
- Support et optimisation continue

Pour 5000+ vocaux/mois ou besoins spécifiques (modèle dédié, vocabulaire métier), devis sur mesure. [Audit gratuit de 30 min →](/fr/contact)
