...
- **Build**: engineering salaries (2 engineers × 4 months upfront + 0.5 FTE ongoing) + LLM API (estimation personnalisee/mo) + infra (estimation personnalisee/mo) + Meta cost (estimation personnalisee/mo depending on country)
