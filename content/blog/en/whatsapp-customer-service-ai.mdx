...
- Cost per ticket is **measurable** (estimation personnalisee typical for tier-1 human handling)
...
| CSAT | 65-75% | 82-90% |
| Cost per resolved ticket | estimation personnalisee | estimation personnalisee |
