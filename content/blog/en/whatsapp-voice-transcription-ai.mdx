...
| Model | EN Accuracy | Multilingual Accuracy | Latency | Cost/min |
|-------|-------------|----------------------|---------|----------|
| **Whisper v3 large** | 97% | 99 languages, excellent | 2-4 s | $0.006 |
| **GPT-4o Audio** | 98% | 50 languages, top tier | 1-2 s | $0.015 |
| **Deepgram Nova-2** | 96% | 30 languages | &lt;1 s | $0.004 |
| **AssemblyAI Universal** | 95% | 28 languages | 1.5 s | $0.005 |
| **Google Speech-to-Text** | 94% | 125 languages | 1-2 s | $0.016 |
...
"Hi, I'm looking for a quote for a fitted kitchen, oak finish, about 18m², induction hob, pyrolytic oven, max budget £15,000". The agent identifies all criteria, checks the catalogue, generates a pre-filled quote.
...
## How Much Does a WhatsApp Agent with Voice Transcription Cost?

From **€290/month** (AgenticWhatsup standard SMB plan), all included:

- WhatsApp Business Cloud API
- Whisper v3 or GPT-4o Audio transcription
- Orchestrating LLM (Claude Sonnet or GPT-4)
- CRM/calendar integration (HubSpot, Pipedrive, Cal.com, Make.com)
- EU hosting + GDPR compliance
- Continuous support and optimisation

For 5,000+ voice notes/month or specific needs (dedicated model, industry vocabulary), custom quote. [Free 30-minute audit →](/en/contact)
